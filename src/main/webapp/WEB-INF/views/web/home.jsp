...
<body>
    ...
    <div class="about_backtop">
        <div class="backtop">
            <i class="fa fa-angle-double-up" style="font-size: 30px; color: white;"></i>
        </div>
